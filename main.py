...
class Main:
    ...
    def __init__(self):
        ...
        # Appeler Main affiche l'interface
    ...
    def interface(self):
        ...
        # Texte d'erreur ou de succès

        self.info_label = tk.Label(self.root, text="")
        self.info_label.grid(row=9, column=0, columnspan=5, sticky="NSEW", pady=5)

        # Création des boutons pour ajouter, modifier et supprimer un produit
        ...
        # Création des boutons pour filtrer les produits par catégorie
    ...
    def liste_categories(self):
        ...
        # Récupérer la liste des noms de categories dans la base de données
    ...
    def nom_categorie(self, id):
        ...
        # Récupérer le nom d'une categorie à partir de son ID
    ...
    def id_categorie(self, nom):
        ...
        # Récupérer l'ID d'une categorie à partir de son nom
    ...
    def ajouter_categorie(self):
        ...
        # Ajouter une categorie dans la base de données
    ...
    def liste_produits(self):
        ...
        # Récupérer la liste des produits dans la base de données
    ...
    def export_csv(self):
        ...
        # Exporter la liste des produits dans un fichier CSV
